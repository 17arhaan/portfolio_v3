...
export default function WorkTimeline() {
  ...
  return (
    <>
      <div className="w-full min-h-screen bg-black text-white p-6 md:p-10 flex flex-col items-center justify-center relative">
              ...
              {workExperience.map((_, index) => (
                <motion.button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all duration-200 cursor-pointer ${
                    index <= activeIndex ? "bg-white" : "bg-white/20 hover:bg-white/40"
                  }`}
                  style={{
                    boxShadow: index <= activeIndex ? "0 0 8px rgba(255, 255, 255, 0.4)" : "none",
                  }}
              ...
              <div className="grid gap-6 md:grid-cols-[auto_1fr_2fr]">
                ...
                <div className="flex justify-center items-start pt-1">
                  <motion.div
                    ...
                    className="w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden bg-white/5 flex items-center justify-center border border-white/5"
                    style={{
                ...
                <div className="space-y-3">
                  ...
                  >
                    ...
                    {activeIndex === latestPositionIndex && (
                      <span className="ml-2 inline-block px-2 py-0.5 text-xs rounded-full bg-white/5 text-white/90 border border-white/10">
                        Latest
                      </span>
                    )}
                  </motion.h2>
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      >
                        {workExperience[activeIndex].company}
                      </span>
                    </motion.div>
                  ...
                  >
                    {workExperience[activeIndex].skills.map((skill, index) => (
                      <motion.div
                        ...
                        className="inline-flex items-center px-2.5 py-1 text-xs rounded-full bg-white/5 text-white/90 border border-white/5 cursor-default"
                      >
                        <Award className="h-3 w-3 mr-1 text-white/70" />
                        {skill}
                      </motion.div>
                    ))}
                  </motion.div>
        ...
        <motion.div
          ...
          whileHover={{ y: 5 }}
        >
          <span className="text-white/70 text-sm mb-2">View Projects</span>
          <motion.div
            animate={{ y: [0, 5, 0] }}
