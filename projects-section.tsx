...
export default function ProjectsSection() {
  ...
  return (
    <div className="w-full min-h-screen bg-black text-white p-6 md:p-10 flex flex-col items-center justify-start relative">
      ...
      {filteredProjects.length > 0 ? (
        <motion.div
          ...
          className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10"
        >
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  {project.featured && (
                    <motion.div
                      ...
                      className="absolute top-2 left-2 flex items-center space-x-1 bg-black/50 backdrop-blur-sm px-2 py-1 rounded-full"
                    >
        ...
        {selectedProject && (
          ...
          >
            <motion.div
              ...
              className="bg-black/90 border border-white/10 rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto"
              style={{
